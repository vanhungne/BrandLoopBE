...
namespace BrandLoop.Infratructure.Migrations
{
    ...
    [Migration("20250624152714_uiauia")]
    partial class uiauia
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BrandLoop.Domain.Entities.InfluencerReport", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("InfluencerReportId"));
            ...
            modelBuilder.Entity("BrandLoop.Domain.Entities.KolsJoinCampaign", b =>
                {
                    ...
                    b.HasIndex("InfluencerReportId")
                        .IsUnique()
                        .HasFilter("[InfluencerReportId] IS NOT NULL");
            ...
            modelBuilder.Entity("BrandLoop.Domain.Entities.KolsJoinCampaign", b =>
                {
                    ...
                    b.HasOne("BrandLoop.Domain.Entities.InfluencerReport", "InfluencerReport")
                        .WithOne()
                        .HasForeignKey("BrandLoop.Domain.Entities.KolsJoinCampaign", "InfluencerReportId")
                        .OnDelete(DeleteBehavior.Restrict);
