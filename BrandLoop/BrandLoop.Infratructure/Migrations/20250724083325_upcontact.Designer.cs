...
namespace BrandLoop.Infratructure.Migrations
{
    ...
    [Migration("20250724083325_upcontact")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BrandLoop.Domain.Entities.ContactMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2025, 7, 24, 8, 33, 23, 411, DateTimeKind.Utc).AddTicks(7589));
            ...
            modelBuilder.Entity("BrandLoop.Domain.Entities.CampaignReport", b =>
                {
                    b.HasOne("BrandLoop.Domain.Entities.Campaign", "Campaign")
                        ...
                        .HasForeignKey("BrandLoop.Domain.Entities.CampaignReport", "CampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BrandLoop.Domain.Entities.Evidence", b =>
                {
                    ...
                    b.HasOne("BrandLoop.Domain.Entities.KolsJoinCampaign", "KolsJoinCampaign")
                        .WithMany("BrandEvidences")
                        .HasForeignKey("KolsJoinCampaignId");
            ...
            modelBuilder.Entity("BrandLoop.Domain.Entities.Feedback", b =>
                {
                    ...
                    b.HasOne("BrandLoop.Domain.Entities.User", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BrandLoop.Domain.Entities.User", "ToUser")
                        .WithMany()
